...
# Blocker 1 & 2: simplify pipeline files don't exist yet
_simplify_prompt_mock = MagicMock()
_simplify_prompt_mock.build_simplify_prompt = MagicMock(
    return_value="MOCK SIMPLIFY PROMPT"
)
sys.modules.setdefault("app.agent.simplify_prompt", _simplify_prompt_mock)
...
sys.modules.setdefault("app.agent.simplify_parser", _simplify_parser_mock)
